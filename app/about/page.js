        ...
        <div className="min-h-screen bg-black text-gray-200">
            ...
            <main className="container py-20 max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-20">
                    <div className="p-8 rounded-2xl border border-white/10 bg-[var(--bg-card)] backdrop-blur-xl bg-gray-900/40">
                ...
                <div className="p-10 rounded-2xl border border-white/10 bg-[var(--bg-card)] backdrop-blur-xl bg-gradient-to-br from-gray-900/80 to-purple-900/20">
