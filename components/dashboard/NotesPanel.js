        ...
        <div className="h-full flex flex-col">
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-base font-semibold text-gray-400 uppercase tracking-wider">Notes</span>
                </div>
                {saved && (
            ...
            <textarea
                ...
                className="flex-1 w-full min-h-[300px] bg-gray-900/50 border border-white/5 rounded-xl p-4 text-base text-gray-300 leading-relaxed resize-none outline-none focus:border-amber-500/30 focus:ring-1 focus:ring-amber-500/10 transition-all placeholder:text-gray-700"
