...
# OUTPUT (STRICT JSON)
{
  "strengths": ["Max 15 words per item. Evidence-backed matches"],
  "weaknesses": ["Max 15 words per item. Evidence-backed gaps"],
  "opportunities": ["Max 15 words per item. Specific transferable skills with bridge explanation"],
  "threats": ["Max 15 words per item. Specific risks with reasoning"],
  "matchScore": 0-100,
...
# OUTPUT (STRICT JSON)
{
  "keyTalkingPoints": [
    {
      "point": "Concise action item — max 10 words",
  ...
  "tailoredAdvice": "2 sentences max. Actionable coaching — NOT a script. Reference specific candidate strengths and role requirements."
}
