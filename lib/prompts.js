...
4. SALARY INTELLIGENCE: If salary is not listed, infer a market range based on title + location + seniority using your training data. State confidence level.
...
# OUTPUT FORMAT (STRICT JSON)
{
  ...
  "salary": "Listed range, or 'Estimated: $X-$Y (confidence: high|medium|low)' if unlisted",
  ...
  "companyDescription": "1-2 sentences about the company if mentioned in the posting",
  ...
  "interviewPrepNotes": {
    ...
    "questionsToAsk": ["Questions that reference specific things in the posting — NOT generic 'what does growth look like' questions"],
    "potentialRedFlags": ["Things from the posting the candidate should probe further"]
  },
...
5. SALARY CONTEXT: Based on title, location, and industry, estimate competitive market salary range.
...
# OUTPUT (STRICT JSON)
{
  ...
  "salaryContext": "Estimated market range for this title/location/industry, with confidence level",
  "hiringUrgency": {
